 ...
 * FILENAME      :  ADC083XGpioProvider.java  
 * 
 ...
 * 
 * <p>
 * This GPIO provider implements the ADC0831 Analog to Digital converter series. 
 * The ADC0831 series are 8-bit successive approximation A/D converters 
 * with a serial I/O and configurable input multiplexers with up 8 channel
 * </p>
 * 
 * <p>
 * 2-, 4- or 8- analog input channel multiplexer options
 * 0V to 5V input range with single 5V supply
 * values returned are in the range 0-255 (max 8 bit value)
 * More information about the ADC can be found here: www.me.psu.edu/rahn/me462/ADC0831.pdf
 * </p>
 * 
 * @author alexandre91
 */

public abstract class ADC0832GpioProvider2 extends GpioProviderBase {

    public static final String NAME = "com.pi4j.gpio.extension.adc.ADC083XGpioProvider";
    public static final String DESCRIPTION = "ADC083X GPIO Provider";
    public static final int INVALID_VALUE = -1;

    //monitor thread that reads analog value from adc channels. ADCMonitor is a inner class.
    ...
    // Analog input pins for ADC channels
    protected GpioPinAnalogInput[] allPins = null;

    // the threshold used to determine if a significant value warrants an event to be raised
    protected double[] threshold = { 1, 1, 1, 1, 1, 1, 1, 1 }; //one value for each possible channel (max 8 channels)
