 ...
 * FILENAME      :  LightSensorComponent.java  
 * 
...
public class AnalogSensorComponent extends AnalogSensorBase {
    ...
    private GpioPinListenerAnalog pinListener = new GpioPinListenerAnalog() {
        ...
        public void handleGpioPinAnalogValueChangeEvent(GpioPinAnalogValueChangeEvent event) {
            ...
            notifyListeners(new AnalogSensorValueChangeEvent(sensor, ((GpioProviderBase)pin.getProvider()).getValue(pin.getPin()), event.getValue()));
        }
    };
