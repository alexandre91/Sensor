 ...
 * FILENAME      :  ADC0832GpioProvider.java  
 * 
...
public class ADC0832GpioProvider extends GpioProviderBase {
    ...
    public static final String NAME = "ADC0832GpioProvider";
...
//Analog Input pins
	...
	public GpioPinAnalogInput createAnalogInputPin(int channel, String name) {
    	    ...
    	    GpioPinAnalogInput pin = GpioFactory.getInstance().provisionAnalogInputPin(this, new PinImpl(ADC0832GpioProvider.NAME, channel, "ADC0832 CH" + channel, EnumSet.of(PinMode.ANALOG_INPUT)), name);
	 ...
	 */
	public ADC0832GpioProvider(Pin CS, Pin CLK, Pin DIO) {
		...
		this.CH1 = null; //createAnalogInputPin(1, "ANALOG INPUT 1");
	        ...
	        monitor = new ADC0832GpioProvider.ADCMonitor();
	        monitor.start();		

	}

	public ADC0832GpioProvider(Pin CS, Pin CLK, Pin DI, Pin DO) {
		// not implemented yet
	}
			...
			int i = 0;
			    ...
			    if (gpioPin != null) { //only try to get analog value if gpioPin (channel) != null
                            ...
                            //try{                        
                                ...
                                try{
                                    if (ADC0832GpioProvider.CONVERSION_DELAY > 0){
                                        Thread.sleep(ADC0832GpioProvider.CONVERSION_DELAY);
                                    }
                                }
                                catch (InterruptedException e) { 
                                    e.printStackTrace();
