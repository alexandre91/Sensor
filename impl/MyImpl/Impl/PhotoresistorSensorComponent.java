...
public class PhotoresistorSensorComponent extends PhotoresistorSensorBase {
    
    // internal class members
    private GpioPinAnalogInput pin = null;
    private final PhotoresistorSensor sensor = this;
    ...
    private GpioPinListenerAnalog pinListener = new GpioPinListenerAnalog() {
        ...
        public void handleGpioPinAnalogValueChangeEvent(GpioPinAnalogValueChangeEvent event) {
            ...
            notifyListeners(new PhotoresistorChangeEvent(sensor, getValue(), event.getValue()));
        }
    };
